...
- Added Nebula, EuphoriaTheme, Arix Theme, Stellar Theme, Apollo Theme, and Nexora Theme entries.
- Installed themes display a green dot when the SKN theme marker exists.
- Actual theme installation packages/integration are not bundled unless provided by the theme author.
